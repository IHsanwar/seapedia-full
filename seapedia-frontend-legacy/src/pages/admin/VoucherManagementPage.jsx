            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="destructive" size="icon" onClick={() => handleDelete(voucher.id)}>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium">Rp {parseInt(voucher.minimum_purchase).toLocaleString('id-ID')}</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Remaining Usage</p>
                  <p className="font-medium">{voucher.remaining_usage === 0 ? 'Unlimited' : voucher.remaining_usage}</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Expires</p>
                  <p className="font-medium">{new Date(voucher.expired_at).toLocaleDateString('id-ID')}</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Status</p>
                  <p className={`font-medium ${voucher.is_active ? 'text-green-600' : 'text-red-600'}`}>
