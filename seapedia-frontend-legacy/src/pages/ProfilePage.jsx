          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full overflow-hidden border-2 border-primary/20 flex items-center justify-center">
                  {profile?.avatar_url ? (
