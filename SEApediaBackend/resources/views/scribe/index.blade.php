    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-auth-register">Register a new buyer.

Registers a new user and automatically assigns the 'buyer' role.
Returns the user object along with a Sanctum access token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-login">
                                <a href="#authentication-POSTapi-v1-auth-login">Login user.
...
Returns the user object along with a Sanctum access token.</a>
                                ...
                                <a href="#authentication-GETapi-v1-auth-me">Get authenticated user.

Returns the currently authenticated user based on the Bearer token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-switch-role">
                                <a href="#authentication-POSTapi-v1-auth-switch-role">Switch active role.

Switch the current active role to another role owned by the user.
Returns a new access token with the requested role ability.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-add-role">
                                <a href="#authentication-POSTapi-v1-auth-add-role">Register/Add a new role to the authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-auth-logout">
                                <a href="#authentication-POSTapi-v1-auth-logout">Logout user.

Revokes the current user's access token.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-store">GET api/store</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-store">
                                <a href="#endpoints-DELETEapi-store">DELETE api/store</a>
                            </li>
                    ...
                    <ul id="tocify-header-profile-dashboard" class="tocify-header">
                <li class="tocify-item level-1" data-unique="profile-dashboard">
                    <a href="#profile-dashboard">Profile & Dashboard</a>
                </li>
                                    <ul id="tocify-subheader-profile-dashboard" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="profile-dashboard-GETapi-profile-dashboard">
                                <a href="#profile-dashboard-GETapi-profile-dashboard">Get multi-role dashboard summary.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>APIs for managing users by administrators.</p>
                                ...
                                <h2 id="admin-user-management-GETapi-v1-admin-users">List all users.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="admin-user-management-POSTapi-v1-admin-users">Create user.</h2>
...
<p>Must match an existing stored value. Example: <code>architecto</code></p>
                    ...
                    <h2 id="admin-user-management-GETapi-v1-admin-users--id-">Show user.</h2>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="admin-user-management-PUTapi-v1-admin-users--id-">Update user.</h2>
...
<p>Must match an existing stored value. Example: <code>architecto</code></p>
                    ...
                    <h2 id="admin-user-management-DELETEapi-v1-admin-users--id-">Delete user.</h2>
...
<p>The ID of the user. Example: <code>1</code></p>
                ...
                <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-v1-auth-register">Register a new buyer.

Registers a new user and automatically assigns the &#039;buyer&#039; role.
Returns the user object along with a Sanctum access token.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="ldzsnrwtujwvlxjklqppwqbewt"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>ldzsnrwtujwvlxjklqppwqbewt</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-v1-auth-login">Login user.
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="authentication-GETapi-v1-auth-me">Get authenticated user.

Returns the currently authenticated user based on the Bearer token.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-auth-switch-role">Switch active role.

Switch the current active role to another role owned by the user.
Returns a new access token with the requested role ability.</h2>
...
<span id="example-requests-POSTapi-v1-auth-switch-role">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-auth-switch-role">
</span>
<span id="execution-results-POSTapi-v1-auth-switch-role" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-switch-role"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-switch-role"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-switch-role" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-switch-role">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-switch-role" data-method="POST"
      data-path="api/v1/auth/switch-role"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-switch-role', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-switch-role"
                    onclick="tryItOut('POSTapi-v1-auth-switch-role');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-switch-role"
                    onclick="cancelTryOut('POSTapi-v1-auth-switch-role');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-switch-role"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/switch-role</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-switch-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-switch-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="POSTapi-v1-auth-switch-role"
               value="architecto"
               data-component="body">
    <br>
<p>Must match an existing stored value. Example: <code>architecto</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-auth-add-role">Register/Add a new role to the authenticated user.</h2>
...
<span id="example-requests-POSTapi-v1-auth-add-role">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-auth-add-role">
</span>
<span id="execution-results-POSTapi-v1-auth-add-role" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-add-role"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-add-role"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-add-role" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-add-role">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-add-role" data-method="POST"
      data-path="api/v1/auth/add-role"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-add-role', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-add-role"
                    onclick="tryItOut('POSTapi-v1-auth-add-role');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-add-role"
                    onclick="cancelTryOut('POSTapi-v1-auth-add-role');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-add-role"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/add-role</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-add-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-add-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="POSTapi-v1-auth-add-role"
               value="buyer"
               data-component="body">
    <br>
<p>Example: <code>buyer</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>buyer</code></li> <li><code>seller</code></li> <li><code>driver</code></li></ul>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-v1-auth-logout">Logout user.

Revokes the current user&#039;s access token.</h2>
    ...
    &quot;data&quot;: [
        {
            &quot;id&quot;: 3,
            &quot;user_id&quot;: 5,
            &quot;reviewer_name&quot;: &quot;Aeternus&quot;,
            &quot;rating&quot;: 3,
            &quot;comment&quot;: &quot;tes&quot;,
            &quot;created_at&quot;: &quot;2026-06-18T09:21:57.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-06-18T09:21:57.000000Z&quot;
        },
        {
            &quot;id&quot;: 2,
            &quot;user_id&quot;: null,
            &quot;reviewer_name&quot;: &quot;Rendi Preatama&quot;,
            &quot;rating&quot;: 2,
            &quot;comment&quot;: &quot;Appnya kurang bagus ah&quot;,
            &quot;created_at&quot;: &quot;2026-06-17T04:47:03.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-06-17T04:47:03.000000Z&quot;
        },
        {
            &quot;id&quot;: 1,
            &quot;user_id&quot;: 2,
            &quot;reviewer_name&quot;: &quot;Cifera&quot;,
            &quot;rating&quot;: 5,
            &quot;comment&quot;: &quot;dasdadas&quot;,
            &quot;created_at&quot;: &quot;2026-06-17T04:46:34.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-06-17T04:46:34.000000Z&quot;
        }
    ]
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="store_name"                data-endpoint="POSTapi-store"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-store"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="logo"                data-endpoint="POSTapi-store"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="banner"                data-endpoint="POSTapi-store"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-store">DELETE api/store</h2>
...
<span id="example-requests-DELETEapi-store">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-store">
</span>
<span id="execution-results-DELETEapi-store" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-store"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-store"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-store" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-store">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-store" data-method="DELETE"
      data-path="api/store"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-store', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-store"
                    onclick="tryItOut('DELETEapi-store');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-store"
                    onclick="cancelTryOut('DELETEapi-store');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-store"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-store"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-store"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="profile-dashboard">Profile & Dashboard</h1>

    <p>APIs for viewing user profile and multi-role dashboard summaries.</p>

                                <h2 id="profile-dashboard-GETapi-profile-dashboard">Get multi-role dashboard summary.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the user's basic profile, owned roles, current active role,
and a placeholder for financial summaries across all their roles
(e.g. Wallet, Seller Income, Driver Earnings).</p>
<p>A user with multiple roles needs to know their overall financial status,
even if their active role restricts their access to certain features.</p>

<span id="example-requests-GETapi-profile-dashboard">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/profile/dashboard" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/profile/dashboard"
);
...
<span id="example-responses-GETapi-profile-dashboard">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-profile-dashboard" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-profile-dashboard"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-profile-dashboard"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-profile-dashboard" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-profile-dashboard">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-profile-dashboard" data-method="GET"
      data-path="api/profile/dashboard"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-profile-dashboard', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-profile-dashboard"
                    onclick="tryItOut('GETapi-profile-dashboard');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-profile-dashboard"
                    onclick="cancelTryOut('GETapi-profile-dashboard');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-profile-dashboard"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/profile/dashboard</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-profile-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-profile-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
